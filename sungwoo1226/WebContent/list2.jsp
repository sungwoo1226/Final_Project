...
<body>
	<jsp:include page="share/header.jsp">
		<jsp:param name="current" value="Lecture_list2" />
	</jsp:include>

	<div class="container">
		<table class="table table-bordered table-stripped">
			<tr>
				<td><img src="img/winners.jpg" width="200" height="300" alt="" />
				
				<ul>
				<li>강좌유형 : 내신(진도)</li>
				<li>강좌구성 : 주 1회 / 총 14강 1676분</li>
				<li>제작방식 : 동영상 강의</li>
				</ul>
				</td>
				<td><img src="img/rpm.jpg" width="200" height="300" alt="" />
